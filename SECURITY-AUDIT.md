...
```
forge test                                   → 129 unit/invariant passing, warning-free build
forge test (+ live forks: UNICHAIN+HYPEREVM) → 136 / 136 passing (7 fork tests replay all 3 legs on real chain state)
