...
```
forge test                                   → 135 unit/invariant passing, warning-free build
forge test (+ live forks: UNICHAIN+HYPEREVM) → 142 / 142 passing (7 fork tests replay all 3 legs on real chain state)
